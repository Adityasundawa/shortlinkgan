...
function getIpAddress() {
    if (!empty($_SERVER['HTTP_CLIENT_IP'])) {
        // Cek ip dari share internet
        $ip = $_SERVER['HTTP_CLIENT_IP'];
    } elseif (!empty($_SERVER['HTTP_X_FORWARDED_FOR'])) {
        // Cek ip jika melewati proxy
...
// Gunakan API ip-api.com untuk mendapatkan data lokasi
// Catatan: Layanan gratis ini memiliki batasan penggunaan.
