...
@section('main-content')
    <div class="pc-container">
        ...
        @if (session('success_alert_message'))
                    <div class="container mt-3">
                        <div class="alert alert-success alert-dismissible fade show" role="alert" id="bulkResultAlert">

                            @php
                                $messages = explode("\n", session('success_alert_message'));
                            ...
                            <pre class="mb-0" style="white-space: pre-wrap; word-break: break-all; font-size: 0.9em; background: none; border: none; padding: 0;">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modelNewShortLinkLabel">Add New Bulk Short Link</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('bulk.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <label for="original_urls" class="form-label">Daftar Original URL</label>
                                    <textarea name="original_urls" id="original_urls" class="form-control" cols="30" rows="10"
                                        placeholder="Masukkan URL, pisahkan dengan baris baru (Satu URL per baris). Contoh:&#10;https://www.google.com&#10;https://laravel.com/docs"></textarea>
