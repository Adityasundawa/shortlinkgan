...
@section('page.title',''.$detail->title.' | Analytic')
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('project_analytic.list') }}">Analytic Microsite</a></li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Analytic Microsite</h2>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    function filterData(start = new Date, end = new Date) {
        let url = `{{ route('microsite_analytic.analytic_json', ['project_id'=>':dataID']) }}`.replace(':dataID', `{{ $detail->id }}`)
        axios.get(url, {
                params: {
                    start: start
                    , end: end
